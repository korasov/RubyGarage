...
;
(function() { this.JST || (this.JST = {}); this.JST["templates/edit-header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input class=\'input-sm\'  name=\'header\' />\n<button id=\'save-btn\' class=\'btn btn-sm\'>Save</button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/edit-task"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n\t<label>\n\t\tTitle\n\t\t<input class=\'title\' class="form-control" placeholder="Title">\n\t</label>\n</div>\n<div>\n\t<label>\n\t\tDeadline\n\t\t<input class=\'deadline\' class="form-control" placeholder="Deadline">\n\t</label>\n</div>\n<div>\n\t<button class=\'btn btn-sm\' id=\'save-task\'>Save</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/main"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<header>\n\t<h3>\n\t\tSimple Todo Tasks\n\t</h3>\n\t<h5>\n\t\tFrom Ruby Garage\n\t</h5>\n</header>\n<div id=\'container\'></div>\n<button class=\'beautiful-button\'>\n\t<div>\n\t\t<span class=\'plus\'>+</span>\n\t\t<span class=\'button-text\'>Add TODO List</span>\n\t</div>\n</button>\n<footer>&#169; Ruby Garage</footer>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/modal-header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id=\'header-dialog\'>\n\t<p> This is a dialog.</p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/task"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="col-xs-1">\n\t<label>\n\t\t<input type=\'checkbox\' class=\'isSelected\' />\n\t</label>\n</div>\n\n<div class="col-xs-8" >\n\t<div class="wrapper"></div>\n\t<div name=\'title\'></div>\n</div>\n\n<div class="col-xs-3">\n\t<span class=\'edit-box\'>\n\t\t<span class=\'glyphicon glyphicon-sort grey\'></span>\n\t\t<span class=\'grey separate\'>|</span>\n\t\t<span class=\'glyphicon glyphicon-pencil grey\'></span>\n\t\t<span class=\'grey separate\'>|</span>\n\t\t<span class=\'glyphicon glyphicon-trash grey\'></span>\n\t</span>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["templates/todo"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'header\'>\n\t<button class=\'btn header-button\'>\n\t\t<span class=\'glyphicon glyphicon-calendar\' />\n\t</button>\n\t<span class=\'header-info\' name=\'header\'>\n\n\t</span>\n\t\n\t<span class=\'pull-right toggle-show\'>\n\t\t<button id=\'edit-todo\' class=\'btn header-button\'>\n\t\t\t<span class=\'glyphicon glyphicon-pencil grey\' />\n\t\t</button>\n\t\t<span class=\'grey separate\'>|</span>\n\t\t<button id=\'delete-todo\' class=\'btn header-button\'>\n\t\t\t<span class=\'glyphicon glyphicon-trash grey\' />\n\t\t</button>\n\t</span>\n</div>\n\n<div class=\'add-info\'>\n\t<div class="input-group input-group-sm">\n\t\t<span class="glypicon glyphicon-plus input-group-addon plus"></span>\n\t\t<input  class="form-control" placeholder=\'Start typing here to create a task...\' />\n\t\t<span class="input-group-addon add-task">Add Task</span>\n\t</div>\n</div>\n\n<div class=\'taskRow\'>\n</div>\n');}return __p.join('');};
}).call(this);
window.tasks = {
	todos: {
